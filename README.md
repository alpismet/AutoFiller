...
- Clean source/build split with `src/`, `public/`, and `dist/`
...
- Review the requested permissions in `public/manifest.json` before loading the extension in a primary browser profile.
